...
import {
  ConfirmPopupType,
  ContextMenuStateHeadType,
  ContextMenuStateType,
  DataTableAction,
  DataTableCellActionFn,
  DataTableCellDef,
  DataTableColumnDef,
  DataTableKeys,
  DataTableDirectionType,
...
> & {
  ...
  // Sort
  onChangeSort: (columnKey: string, orderDirection?: DataTableDirectionType) => void;
};
  ...
  <T,>({ children, keyName = "id", ...props }: DataTableProviderProps) => {
    ...
    const onChangeSort = useCallback(
      (columnKey: string, _orderBy?: DataTableDirectionType) => {
        ...
        const orderDirection = _orderBy ?? (preOrderBy === "asc" ? "desc" : "asc");
